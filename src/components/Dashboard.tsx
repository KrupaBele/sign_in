...
const Dashboard = () => {
  ...
  const fetchDocuments = async () => {
    try {
      const response = await axios.get(`http://localhost:3001/api/documents/user/${userEmail}`);
    ...
    <div className="space-y-6">
      ...
      {documents.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-4">Get started by uploading your first document for signing.</p>
          <Link
            to="/upload"
